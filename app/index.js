...
var ArchetypeJekyllGenerator = module.exports = function ArchetypeJekyllGenerator(args, options) {
...
// User input
ArchetypeJekyllGenerator.prototype.askForAuthor = function askForAuthor() {
  var cb = this.async();
...
ArchetypeJekyllGenerator.prototype.directories = function directories() {
...
ArchetypeJekyllGenerator.prototype.jekyllFiles = function jekyllFiles() {
...
ArchetypeJekyllGenerator.prototype.jsPreprocessor = function jsPreprocessor() {
  if (this.jsPre) {
